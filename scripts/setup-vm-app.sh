...
echo "  3. kubectl label node homie-ai node-role.kubernetes.io/worker=worker"
echo "  4. Create secrets — see CLAUDE.md"
echo "  5. Edit k8s/overlays/prod/httproute.yaml + certificate.yaml — set YOUR_DOMAIN"
echo "  6. Edit k8s/overlays/prod/cluster-issuer.yaml — set YOUR_EMAIL"
echo "  7. kubectl apply -f ~/homie/argocd/application.yaml"
